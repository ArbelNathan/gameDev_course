...
public class Mover : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if ((Mathf.Abs(transform.position.x) < -400f) && ((transform.position.x) < -200f) && (speed > 0f))
            speed = 10f;
        else if ((Mathf.Abs(transform.position.x) > -200f) && ((transform.position.x) < 4000f) && (speed > 0f))
            speed = 20f;
        else if ((Mathf.Abs(transform.position.x) > 2000f) && ((transform.position.x) < 6000f) && (speed > 0f))
            speed = 30f;
        else if ((Mathf.Abs(transform.position.x) > 4000f) && ((transform.position.x) < 8000f) && (speed > 0f))
            speed = 20f;
        else if ((Mathf.Abs(transform.position.x) > 6000f) && ((transform.position.x) > 6000f) && (speed > 0f))
            speed = -10f;
